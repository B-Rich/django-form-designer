...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('form_designer_formdefinition', 'body_html', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormDefinition.body_html'
        db.delete_column('form_designer_formdefinition', 'body_html')
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'body_html': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
